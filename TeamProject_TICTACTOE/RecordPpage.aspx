<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecordPpage.aspx.cs" Inherits="RecordPpage" %>
    ...
    <div class="base-page">
        <div class="form" style="text-align: center" >
            <form id="form1" runat="server">
                ...
                <br />
                <div>
                    <asp:Button ID="btnPersonal" CssClass="button4" runat="server" Text="내 기록 보기"/>&nbsp; 
                    <asp:Button ID="btnWhole" CssClass="button3" runat="server" Text="전체 기록 보기" 
                        Width="124px" onclick="btnWhole_Click" /><br />
                </div>
